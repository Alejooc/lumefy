...
5. Cuando la prueba es correcta, crea o completa en NPM un Proxy Host exclusivo hacia `lumefy-storefront-1:3000`, con `/api/v1/storefront/public/` dirigido al backend FastAPI, y solicita el SSL.
