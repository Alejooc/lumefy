...
const SingleItem = ({
  ...
  return (
    <div className="flex flex-col border-t border-gray-3 px-4 py-4 sm:px-7.5 md:flex-row md:items-center md:py-5">
      <div className="w-full md:w-auto md:min-w-[400px]">
        <div className="flex items-start justify-between gap-3 md:items-center md:gap-5">
          <div className="flex min-w-0 w-full items-center gap-3 sm:gap-5.5">
            <div className="flex h-[72px] w-[72px] shrink-0 items-center justify-center rounded-[5px] bg-gray-2 sm:h-17.5 sm:w-[80px]">
              <Image
                width={200}
                height={200}
      ...
      <div className="mt-4 grid grid-cols-2 gap-x-4 gap-y-4 md:mt-0 md:contents">
        ...
        <div className="min-w-0 md:min-w-[275px]">
          ...
          <div className="w-max max-w-full flex items-center rounded-md border border-gray-3">
            ...
            <span className="flex h-11.5 w-16 items-center justify-center border-x border-gray-4">
              {quantity}
            </span>
