      ...
      <div className="flex items-center justify-center ">
        <div className="w-full max-w-[1100px] rounded-xl shadow-3 bg-white p-7.5 relative modal-content">
          ...
          >
            ...
            >
              {/* The original close path is kept below only as a reference; render the validated path instead. */}
              {/*
              <path
                fillRule="evenodd"
                clipRule="evenodd"
              ...
              */}
              <path
                d="M7.2 5.8L13 11.6L18.8 5.8L20.2 7.2L14.4 13L20.2 18.8L18.8 20.2L13 14.4L7.2 20.2L5.8 18.8L11.6 13L5.8 7.2L7.2 5.8Z"
                fill="currentColor"
              />
            </svg>
          </button>
          ...
          <div className="flex flex-wrap items-center gap-12.5">
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-5 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-dark">
                    {product.reviews ? `${product.reviews} reseñas` : "Disponible"}
                  </span>
                </div>
              </div>
              ...
              {metadata.length > 0 && (
                <div className="mt-6 space-y-3 rounded-lg border border-gray-3 bg-gray-1 p-4">
                  {metadata.map((item) => (
                    <div key={item.label} className="flex flex-wrap items-start justify-between gap-2">
                      ...
                      <span className="text-sm text-dark-2 text-right">{item.value}</span>
                    </div>
                  ))}
                </div>
              )}
