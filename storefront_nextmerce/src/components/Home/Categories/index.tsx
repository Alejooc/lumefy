...
const Categories = ({ items, section }: { items: Category[]; section: HomeSection }) => {
  ...
  }, [swiper, items.length, syncNavigationState]);
        ...
        <div className="swiper categories-carousel common-carousel">
          <div className="mb-10 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button onClick={handlePrev} className="swiper-button-prev disabled:cursor-not-allowed disabled:opacity-40" disabled={!swiper || isBeginning}>
              ...
              <button onClick={handleNext} className="swiper-button-next disabled:cursor-not-allowed disabled:opacity-40" disabled={!swiper || isEnd}>
                <svg className="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none">
