...
export default function HeroSlideContent({ slide, headingLevel = 2 }: { slide: HeroSlide; headingLevel?: 1 | 2 }) {
  ...
  return (
    <article className="relative min-h-[500px] overflow-hidden sm:min-h-[590px] lg:min-h-[630px]">
      ...
      >
        ...
        <Heading className="max-w-[540px] text-[38px] font-semibold leading-[1.03] tracking-[-0.035em] sm:text-[54px] lg:text-[62px]">
          {slide.title}
        </Heading>
