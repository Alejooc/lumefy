...
export class IntegrationListComponent implements OnInit, OnDestroy {
  ...
  canonicalLabel(canonical: string): string {
    const labels: Record<string, string> = {
      ...
      'product.internal_reference': 'Referencia interna',
      ...
      'product.brand.external_id': 'ID externo de marca',
      'product.brand.name': 'Marca',
      'product.supplier.external_id': 'ID externo de proveedor',
      'product.supplier.name': 'Nombre de proveedor',
      'product.weight': 'Peso (kg)',
      'product.volume': 'Volumen (L)',
      'product.tax_rate': 'Impuesto (%)',
      'product.min_stock': 'Stock mínimo',
      'product.product_type': 'Tipo de producto',
      'product.track_inventory': 'Controla inventario',
      'product.tracking_type': 'Tipo de seguimiento',
      'product.sale_ok': 'Se puede vender',
      'product.purchase_ok': 'Se puede comprar',
      'product.unit.name': 'Unidad de medida',
      'product.purchase_unit.name': 'Unidad de compra',
