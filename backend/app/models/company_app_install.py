...
class CompanyAppInstall(Base):
    ...
    # Server-side marketing credentials are encrypted at rest and never
    # returned by the marketplace API.
    private_settings: Mapped[dict] = mapped_column(EncryptedGatewayConfig(), nullable=True, default=dict)
